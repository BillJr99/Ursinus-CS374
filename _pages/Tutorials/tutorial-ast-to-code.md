...
Constant folding is the first optimizer most people write, and it is a tree transformation, which is exactly what this tutorial is about.  It was previously embedded in the AST class session.
