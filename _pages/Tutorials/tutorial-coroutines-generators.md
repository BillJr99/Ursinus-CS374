...
comment: Render with https://liascript.github.io/course/?https://raw.githubusercontent.com/BillJr99/Ursinus-CS374/gh-pages/_pages/Tutorials/tutorial-coroutines-generators.md
...
> **Prerequisites:** Python functions and closures (the *Closures and First-Class Functions* activity); the idea of a **continuation** — "the rest of the computation"
...
*End of Tutorial — Coroutines and Generators: yield, send, async/await, state machines, interpreter implementation*
