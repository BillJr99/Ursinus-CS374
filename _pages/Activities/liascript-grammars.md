...
This two-day module puts BNF in its theoretical home.  Grammars come in **classes of power**, and the class a language needs determines the machine that can recognize it.  That is why your project has *both* a lexer, which is regular machinery, and a parser, which is context-free machinery.  Here is where today goes: **formal grammars $\rightarrow$ the four-level hierarchy $\rightarrow$ where programming language constructs live $\rightarrow$ writing context-free grammars for real constructs**.
...
> **Continued next session.**  Day 2 picks up from here: [Grammars, Day 2: Writing Context-Free Grammars](https://www.billmongan.com/LiaScript/?https://raw.githubusercontent.com/BillJr99/Ursinus-CS374-Fall2026/gh-pages/_pages/Activities/liascript-grammars-day2.md).
