...
info: 
  ...
  models:
    - model: |
        <a title="Verpies, Public domain, via Wikimedia Commons" href="https://commons.wikimedia.org/wiki/File:BMPfileFormat.png"><img width="256" alt="BMPfileFormat" src="https://commons.wikimedia.org/w/index.php?title=Special:Redirect/file/BMPfileFormat.png"></a>
