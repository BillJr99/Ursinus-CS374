...
8.  **[Binding and Scope]({{ site.baseurl }}/Assignments/ParticipationExercises/BindingAndScope)** - one exercise in two parts: Part 1 is handed out on the *Tree-Walking Interpretation* day, and Part 2, the Mystery Scoping Language, on the *Binding and Scope* day.  Evaluate a shadowing expression by hand under both lexical and dynamic scope, drawing the environment at each step, then deduce a hidden scoping rule by experiment.
