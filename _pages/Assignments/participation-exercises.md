...
These exercises exist so that class begins where you are, not where the reading assumes you are. Each unit's exercises are handed out on the schedule on the day they prepare you for, as a **Participation: Exercise** deliverable linking to that unit's page; come to that class having attempted them. We will work through them together, compare approaches, and let the places you got stuck set the agenda. A genuine attempt that ran aground is worth more to the discussion than a blank page or a perfect one: the stuck points are the lesson.
