...
info:
  ...
  tilt:
    ...
    criteria: "I assess your work on a correctly ordered token spec, an idempotent side-effect-free Lexer interface, and precise error reporting with a full test suite, weighted 30/40/30 across the three parts; the rubric applies equivalently to whichever direction you choose.  The full breakdown is in the rubric below."
  points: 100
  goals:
...
This is one assignment with one deliverable and one rubric, and you build it in your choice of **direction**:
