...
**Your team over the project's seven weeks.**  Teams reliably pass through recognizable stages (Tuckman, 1965), and I have placed this project's milestones on that map on purpose.  Your **team charter**, drafted at the design-phase milestone and signed with the proposal, is the *forming* work, and you do it before the stakes get high.  The **design phase** is where I expect *storming*.  The argument over which niche to serve and what the design scorecard says is productive conflict, so please have it out loud in your own team meeting instead of quietly in a group chat.  The **Sprint 0 proposal** is *norming* made concrete, a signed and presented agreement about what you are building and who owns what.  The **sprints** are *performing*, where role rotation and stand-ups carry the load and the team self-corrects without drama.  **Demo Day's retrospective** is *adjourning*, so close deliberately, with contribution statements and the portfolio story each member takes away.  If the design phase feels contentious, the map is working.  Run the charter's conflict-repair process and keep going.

**Reference implementation policy.**  Your team may build on the released reference lexer, parser, and interpreter instead of your own semester components, or merge the two, as long as you declare it in the project README.  I grade the language you design and build on top, and I do not care whose components you started from.  Please spend your sprint time on the design, the distinctive feature, and the integration.

---

## Timeline and Milestones

The project is worth **100 points** total, earned at two graded milestones (proposal and Demo Day).  The two small 3-point checkpoints along the way fall within Class Activities and Participation, so they keep the team honest without raising the stakes of a studio day:
...
The project hand-out opens a **design phase**: form your team of three, pick a niche, draft the design scorecard, and draft your team charter.  This phase runs outside class, with no studio session for it, so please budget a team meeting of your own between the hand-out and the milestone.  The design-phase milestone (team, niche, scorecard, and draft charter) is submitted through Canvas (3 points, assessed within Class Activities and Participation); it exists so the graded proposal that follows is a refinement instead of a scramble.
