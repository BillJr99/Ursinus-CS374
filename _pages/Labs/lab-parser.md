...
clean:
        rm main calc.tab.c lex.yy.c calc.tab.h calc.output
```

Ensure that the lines below each label are indented with exactly one tab (not spaces!).  If you are using replit, you will want to enter your Shell tab and type these two commands to install them prior to clicking Run:
